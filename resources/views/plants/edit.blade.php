    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mt-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <x-card title="Edit Plant" :subtitle="'Plant #' . $plant->id">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('plants.update', $plant) }}" method="POST" class="space-y-4">
                        @csrf
                        @method('PATCH')
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" value="{{ old('name', $plant->name) }}"
                                required
                        ...
                        <div>
                            <label for="latin_name"
                                ...
                                Name</label>
                            <input id="latin_name" name="latin_name" type="text"
                        ...
                        <div>
                            ...
                            <input id="garden_id" name="garden_id" type="text"
                                value="{{ old('garden_id', $plant->garden_id) }}" required
                                class="w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100" />
                        </div>
                        <div class="mt-2 flex gap-2">
                            <a href="{{ route('plants.index', $plant) }}"
